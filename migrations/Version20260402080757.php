 ...
 */
final class Version20260402080757 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE configuration CHANGE genres_visibles genres_visibles LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE utilisateur CHANGE image_identite image_identite VARCHAR(50) DEFAULT \'NULL\'');
    }
}
